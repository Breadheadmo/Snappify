/**
 * Email Templates for Snappify E-commerce
 * =====================================
 * 
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f4;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="color: #2563eb; margin: 0; font-size: 2.5em;">🛍️ Snappify</h1>
        ...
        <div style="background-color: #e3f2fd; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
          ...
          <p>Welcome to Snappify! We're thrilled to have you join our community of tech enthusiasts.</p>
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
          ...
          <p style="color: #666; margin: 10px 0;">
            ...
            <a href="mailto:${process.env.SUPPORT_EMAIL || 'support@Snappify.co.za'}" style="color: #2563eb; text-decoration: none;">Contact Support</a>
          </p>
          <p style="color: #999; font-size: 12px; margin: 20px 0 0;">
            Welcome aboard! - The Snappify Team
          </p>
        </div>
      </div>
    </body>
...
const getEmailVerificationTemplate = (user, verificationToken) => {
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Verify Your Email - Snappify</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f4;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
          ...
          <p>Thank you for signing up with Snappify! To complete your registration and start shopping, please verify your email address.</p>
        </div>
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
          ...
          <p style="color: #999; font-size: 12px; margin: 20px 0 0;">
            Need help? Contact us at ${process.env.SUPPORT_EMAIL || 'support@Snappify.co.za'}
          </p>
        </div>
      </div>
    </body>
...
const getNewsletterSubscriptionTemplate = (email) => {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Newsletter Subscription - Snappify</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f4;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
        ...
        <div style="background-color: #f0f9ff; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
          ...
          <p>Thank you for subscribing to the Snappify newsletter with the email: <strong>${email}</strong></p>
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
          ...
          <p style="color: #999; font-size: 12px; margin: 20px 0 0;">
            Thank you for joining our community! - The Snappify Team
          </p>
        </div>
      </div>
    </body>
...
const getOrderCancellationTemplate = (order, user, reason) => {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Order Cancelled - Snappify</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f4;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
          ...
          <p style="color: #999; font-size: 12px; margin: 20px 0 0;">
            We appreciate your understanding - The Snappify Team
          </p>
        </div>
      </div>
    </body>
...
const getWishlistReminderTemplate = (user, wishlistItems) => {
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Items in Your Wishlist - Snappify</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f4;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
          ...
          <p style="color: #999; font-size: 12px; margin: 20px 0 0;">
            Happy shopping! - The Snappify Team
          </p>
        </div>
      </div>
    </body>
...
const getSecurityAlertTemplate = (user, alertType, details) => {
  ...
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Security Alert - Snappify</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f4;">
      <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
          <p style="color: #666; margin: 10px 0;">
            If you need help securing your account, <a href="mailto:${process.env.SUPPORT_EMAIL || 'support@Snappify.co.za'}" style="color: #2563eb; text-decoration: none;">contact our support team</a>
          </p>
          <p style="color: #999; font-size: 12px; margin: 20px 0 0;">
            Your security is our priority - The Snappify Team
          </p>
        </div>
      </div>
    </body>
