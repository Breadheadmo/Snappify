...
const getCategoriesAdmin = asyncHandler(async (req, res) => {
  ...
  if (categories.length === 0) {
    const defaultCategories = [
      ...
      { _id: '3', name: 'Fashion & Beauty', slug: 'fashion-beauty' },
      { _id: '4', name: 'Sports & Fitness', slug: 'sports-fitness' },
      { _id: '5', name: 'Books & Media', slug: 'books-media' },
      { _id: '6', name: 'Automotive', slug: 'automotive' },
      { _id: '7', name: 'Health & Wellness', slug: 'health-wellness' },
      { _id: '8', name: 'Toys & Games', slug: 'toys-games' },
      { _id: '9', name: 'Power On the Go', slug: 'power-on-the-go' },
      { _id: '10', name: 'Other', slug: 'other' }
    ];
